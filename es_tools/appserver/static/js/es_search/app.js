...
require([
    ...
    ChartView
        ...
        mysearch.on('search:start', function (e) {
            // timechart.$el.show()
        })

        timechart = new ChartView({
            id: "example-chart",
        ...
        timechart.on('selection', function (e) {
            console.log('timechart selection', e)
        })

        timechart.on('clicked:chart click:chart', function (e) {
            e.preventDefault()
            console.log('timechart click', e)
        })
